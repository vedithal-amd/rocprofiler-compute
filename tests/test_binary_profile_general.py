...
baseline_opts = ["build/rocprof-compute.bin", "profile", "-n", "app_1", "-VVV"]
...
def test_path():
    ...
    test_utils.launch_binary_rocprof_compute(config, options, workload_dir)
...
def test_kernel_names():
    ...
    workload_dir = test_utils.get_output_dir()
    code = test_utils.launch_binary_rocprof_compute(
